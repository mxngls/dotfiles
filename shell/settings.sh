...
if [[ "$(tput colors)" == "256" ]]; then
  colors256=' -DE210 -DS236.211  -DB210  -DC210 -DR253  -DN253  -Du+214 -Dk+253 -Dd+045 -DP253  -Ds+208 -Dk+069'
  colors16='  -DEr   -DSb.r      -DBr    -DCr   -DRw    -DNw    -Du+y   -Dk+w   -Dd+0c  -DPw    -Ds+y   -Dkb'
