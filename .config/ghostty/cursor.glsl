...
void mainImage(out vec4 fragColor, in vec2 fragCoord)
{
    ...
    // Simple working trail colors with transparency
    vec4 trailColor = vec4(0.7, 0.7, 0.7, 1.0);      // Light gray, 30% opacity
    vec4 trailAccent = vec4(0.6, 0.6, 0.6, 1.0);    // Darker gray, 15% opacity
